...
$(document).ready(function() {      
        ...
        $("body").on("click",".mnSideClose",function(){
			...
			console.log("cerraronpanel");
			callbackPanelSideCerrado();
        });
...
(function ($) 
{
    ...
    $.MetroSidePanel = function (settings,callback) 
    {
        ...
        if(settings.iframe)
            Content +=     '<iframe src="'+settings.iframe+'" class="animated fadeIn" frameborder="0"></iframe>';
        ...
        if(settings.sound===true)
        {
            if(isIE8orlower() == 0)
            {
                ...
                if (navigator.userAgent.match('Firefox/'))
                    audioElement.setAttribute('src', 'http://www.entreinsectos.com/static/sound/messagebox.ogg');
                else
                    audioElement.setAttribute('src', 'http://www.entreinsectos.com/static/sound/messagebox.mp3');
    ...
    $.bigBox = function (settings,callback) 
    {
        ...
        if(settings.sound === true)
        {
            if(isIE8orlower() == 0)
            {
                ...
                if (navigator.userAgent.match('Firefox/'))
                    audioElement.setAttribute('src', 'http://www.entreinsectos.com/static/sound/bigbox.ogg');
                else
                    audioElement.setAttribute('src', 'http://www.entreinsectos.com/static/sound/bigbox.mp3');
        ...
        boxBig =  "<div id='bigBox"+BigBoxes+"' class='bigBox animated fadeIn fast'><div id='bigBoxColor"+ BigBoxes+"'><img class='botClose' id='botClose"+ BigBoxes +"' src='http://www.entreinsectos.com/js/metro/static/img/close.png'>";
        ...
        if(settings.img == undefined)
        {
            settings.img = "http://www.entreinsectos.com/js/metro/static/img/cloud.png";
        }
    ...
    $.smallBox = function (settings,callback) 
    {
        ...
        if(settings.sound===true)
        {
            if(isIE8orlower() == 0)
            {
                ...
                if (navigator.userAgent.match('Firefox/'))
                    audioElement.setAttribute('src', 'http://www.entreinsectos.com/static/sound/smallbox.ogg');
                else
                    audioElement.setAttribute('src', 'http://www.entreinsectos.com/static/sound/smallbox.mp3');
