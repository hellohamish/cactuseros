  ...
  */
 	...
 	// Default Options
		var defaultOptions = {
			...
			boxImage	: '/js/bramus/images/percentImage.png',			// boxImage : image around the progress bar
			barImage	: '/js/bramus/images/percentImage_back.png',	// Image to use in the progressbar. Can be an array of images too.
